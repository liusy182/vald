...
1. Running example
    ...
    If you want to learn the detail of running an example, please refer to the tutorial of [Vald Agent Standalone on Kubernetes](../tutorial/get-started.md/#run-example-code).
